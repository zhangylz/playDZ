...
(function (ui) {
    var howPlayUI = (function (_super) {
        __extends(howPlayUI, _super);
        function howPlayUI() {
            return _super.call(this) || this;
        }
        howPlayUI.prototype.createChildren = function () {
            _super.prototype.createChildren.call(this);
            this.createView(ui.howPlayUI.uiView);
        };
        return howPlayUI;
    }(Dialog));
    howPlayUI.uiView = { "type": "Dialog", "props": { "width": 640, "height": 1164 } };
    ui.howPlayUI = howPlayUI;
})(ui || (ui = {}));
(function (ui) {
...
(function (ui) {
    ...
    myHBUI.uiView = { "type": "Dialog", "props": { "width": 640, "height": 1164 }, "child": [{ "type": "Image", "props": { "y": 392, "x": 30, "width": 655, "skin": "myHbao/myHBao.png", "scaleY": 0.95, "scaleX": 0.95, "height": 419 }, "child": [{ "type": "Image", "props": { "y": 20, "x": 569, "var": "close_button", "skin": "myHbao/off.png", "name": "close_button" } }, { "type": "Image", "props": { "y": 340, "x": 490, "width": 106, "var": "withdraw_button", "skin": "myHbao/image_button.png", "name": "withdraw_button", "height": 54 }, "child": [{ "type": "Label", "props": { "y": 12, "x": 27, "text": "提现", "fontSize": 25, "font": "Arial", "color": "#ffffff", "bold": true } }] }, { "type": "Label", "props": { "y": 320, "var": "balance", "text": "余额: 0 (元)", "name": "balance", "left": 30, "fontSize": 32, "font": "SimHei", "color": "#fd0400", "bold": true } }, { "type": "Label", "props": { "x": 11, "var": "prompt", "text": "温馨提示： 红包满20可以提现", "name": "prompt", "left": 30, "fontSize": 20, "font": "SimHei", "color": "#a39999", "bottom": 30 } }] }] };
    ui.myHBUI = myHBUI;
})(ui || (ui = {}));
(function (ui) {
