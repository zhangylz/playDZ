...
declare const wx: {
     ...
     */
    login(object: {success:(res:any)=>void,fail:(res:any)=>void}): void;
     ...
     * 监听键盘输入事件
     */
    onKeyboardInput(callback: (res:any)=>void): void;
    /**
     * 取消监听键盘输入事件
     */
     ...
     */
    onKeyboardConfirm(callback: (res:any)=>void): void;
    /**
     ...
     * 从本地相册选择图片或使用相机拍照。
     */
    chooseImage(object: {count:number,sizeType:string[],sourceType:string[],success:(res)=>void}): void;
    /**
     * 预览图片
     */
